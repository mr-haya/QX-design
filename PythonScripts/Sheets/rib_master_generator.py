...
mode = "print"  # "print", "lasercut", "jig"
preview = True  # matplotlibでプレビューを表示するか
all_at_once = False  # 一つの図面、ファイルにまとめるか True or False

protrude_length = 1  # 線引き線のはみ出し長さ
...
def main():
    ...
    if preview:
        ...
        fig.savefig(
            os.path.join(cf.Settings.OUTPUTS_PATH, "preview.pdf"),
            transparent=True,
            dpi=300,
        )
        plt.show()
